...
NTEST(DefaultConfig)
{
	...
	config_load("tests/mesytec_mdpp16qdc/empty.cfg");
	crate = crate_create();
...
NTEST(MonitorCollision0)
{
	...
	config_load("tests/mesytec_mdpp16qdc/mon0.cfg");
	crate = crate_create();
	mdpp16qdc = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16QDC, 0);
	mdpp16qdc->mdpp.mxdc32.do_sleep = 0;
...
NTEST(MonitorCollision1)
{
	...
	config_load("tests/mesytec_mdpp16qdc/mon1.cfg");
	crate = crate_create();
	mdpp16qdc = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16QDC, 0);
	mdpp16qdc->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(MonitorCollision2)
{
	...
	config_load("tests/mesytec_mdpp16qdc/mon2.cfg");
	crate = crate_create();
	mdpp16qdc = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16QDC, 0);
	mdpp16qdc->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(TriggerDupT0)
{
	...
	config_load("tests/mesytec_mdpp16qdc/t0.cfg");
	crate = crate_create();
	mdpp16qdc = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16QDC, 0);
	mdpp16qdc->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(TriggerDupT1)
{
	...
	config_load("tests/mesytec_mdpp16qdc/t1.cfg");
	crate = crate_create();
	mdpp16qdc = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16QDC, 0);
	mdpp16qdc->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
