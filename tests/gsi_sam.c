...
NTEST(DefaultConfig)
{
	...
	config_load_without_global("tests/gsi_sam_empty.cfg");
...
NTEST(Tacquila)
{
	...
	config_load_without_global("tests/gsi_sam_tacquila.cfg");
...
NTEST(Cros3)
{
	...
	config_load_without_global("tests/gsi_sam_cros3.cfg");
...
NTEST(Siderem)
{
	...
	config_load_without_global("tests/gsi_sam_siderem.cfg");
...
NTEST(Mixed)
{
	...
	config_load_without_global("tests/gsi_sam_mixed.cfg");
	block = config_get_block(NULL, KW_GSI_SAM);
	NTRY_PTR(NULL, !=, block);
...
NTEST(OverloadForbidden)
{
	...
	config_load_without_global("tests/gsi_sam_overload.cfg");
	block = config_get_block(NULL, KW_GSI_SAM);
	NTRY_PTR(NULL, !=, block);
	NTRY_SIGNAL(sam = (void *)module_create(NULL, KW_GSI_SAM, block));
	(void)sam;
