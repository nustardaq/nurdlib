...
NTEST(DefaultConfig)
{
	...
	config_load("tests/mesytec_mdpp16scp_empty.cfg");
	crate = crate_create();
...
NTEST(MonitorCollision0)
{
	...
	config_load("tests/mesytec_mdpp16scp_mon0.cfg");
	crate = crate_create();
	mdpp16scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16SCP, 0);
	mdpp16scp->mdpp.mxdc32.do_sleep = 0;
...
NTEST(MonitorCollision1)
{
	...
	config_load("tests/mesytec_mdpp16scp_mon1.cfg");
	crate = crate_create();
	mdpp16scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16SCP, 0);
	mdpp16scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(MonitorCollision2)
{
	...
	config_load("tests/mesytec_mdpp16scp_mon2.cfg");
	crate = crate_create();
	mdpp16scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16SCP, 0);
	mdpp16scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(TriggerDupT0)
{
	...
	config_load("tests/mesytec_mdpp16scp_t0.cfg");
	crate = crate_create();
	mdpp16scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16SCP, 0);
	mdpp16scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(TriggerDupT1)
{
	...
	config_load("tests/mesytec_mdpp16scp_t1.cfg");
	crate = crate_create();
	mdpp16scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP16SCP, 0);
	mdpp16scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
