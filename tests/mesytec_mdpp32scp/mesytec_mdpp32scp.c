...
NTEST(DefaultConfig)
{
	...
	config_load("tests/mesytec_mdpp32scp/empty.cfg");
	crate = crate_create();
...
NTEST(MonitorCollision0)
{
	...
	config_load("tests/mesytec_mdpp32scp/mon0.cfg");
	crate = crate_create();
	mdpp32scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP32SCP, 0);
	mdpp32scp->mdpp.mxdc32.do_sleep = 0;
...
NTEST(MonitorCollision1)
{
	...
	config_load("tests/mesytec_mdpp32scp/mon1.cfg");
	crate = crate_create();
	mdpp32scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP32SCP, 0);
	mdpp32scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(MonitorCollision2)
{
	...
	config_load("tests/mesytec_mdpp32scp/mon2.cfg");
	crate = crate_create();
	mdpp32scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP32SCP, 0);
	mdpp32scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(TriggerDupT0)
{
	...
	config_load("tests/mesytec_mdpp32scp/t0.cfg");
	crate = crate_create();
	mdpp32scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP32SCP, 0);
	mdpp32scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
...
NTEST(TriggerDupT1)
{
	...
	config_load("tests/mesytec_mdpp32scp/t1.cfg");
	crate = crate_create();
	mdpp32scp = (void *)crate_module_find(crate, KW_MESYTEC_MDPP32SCP, 0);
	mdpp32scp->mdpp.mxdc32.do_sleep = 0;
	NTRY_SIGNAL(crate_init(crate));
